...
const Logos7 = () => {
  return (
    <section className="overflow-hidden bg-muted py-32 dark:bg-muted">
      <div className="container text-center flex flex-col gap-2 items-center">
        <Text variant="h3" align="center" className="text-balance">
          Powering the world&apos;s best product teams.
        </Text>
        <Text variant="body-large" as="span" color="muted">
